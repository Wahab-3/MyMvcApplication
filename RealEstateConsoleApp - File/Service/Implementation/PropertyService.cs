...
namespace RealEstateConsoleApp.Service.Implementation
{
    public class PropertyService : IPropertyService
    {
        ...
        {
            int count = ContextClass.properties.Count == 0 ? 1 : ContextClass.properties.Count + 1;
            ...
            var newProperty = new Property { Id = count, CartegoryId = cartegoryId, Location = Location, Price = Price, IsAvailable = true, Description = Description, OwnersTagNumber = tagnumber.ToString(), UserEmail = UserEmail, CartegoryName = getCartegoryById.Name, TypeOfLeases = TypeOfLeases };
