...
namespace RealEstateConsoleApp.Service.Implementation
{
    public class UserService : IUserService
    {
        ...
        {
            int count = ContextClass.users.Count == 0 ? 1 : ContextClass.users.Count + 1;
            var newUser = new User { Id = count, Email = Email, FirstName = FirstName, LastName = LastName, PhoneNumber = PhoneNumber, Age = Age, Address = Address, Gender = gender, RoleName = RoleName, Password = Password, Wallet = 0 };
        ...
        public void DeleteUser(string Email)
        {
            ...
            userRepository.RefreshUserFile();
        ...
        public void UpdateUser(string OldEmail, string Email, string FirstName, string LastName, long PhoneNumber, int Age, string Address, Gender Gender, string Password, double Wallet)
        {
