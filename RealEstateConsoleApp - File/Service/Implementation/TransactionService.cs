...
namespace RealEstateConsoleApp.Service.Implementation
{
    public class TransactionService : ITransactionService
    {
        ...
        {
            int count = ContextClass.transactions.Count == 0 ? 1 : ContextClass.transactions.Count + 1;
            var property = propertyRepository.GetPropertyById(PropertyId);
            var newTransaction = new Transaction { Id = count, UserEmail = UserEmail, TotalPrice = property.Price, PropertyId = PropertyId, TypeOfLeases = property.TypeOfLeases, IsSucessfull = true };
        ...
        public void DeleteTransaction(int id)
        {
            ...
            transactionRepository.RefreshTransactionFile();
