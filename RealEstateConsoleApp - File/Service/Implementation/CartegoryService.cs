...
namespace RealEstateConsoleApp.Service.Implementation
{
    public class CartegoryService : ICartegoryService
    {
        ...
        {
            int count =ContextClass.cartigories.Count == 0 ? 1 : ContextClass.cartigories.Count + 1;
            var newCartegory = new Cartegory{Id = count ,Name = Name, Description =Description};
        ...
        public void DeleteCartegory(string name)
        {
            ...
            cartegoryRepository.RefreshCartegoryFile();
