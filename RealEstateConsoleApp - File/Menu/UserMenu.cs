    ...
    public class UserMenu
    {
        ...
        public void UpdateWallet()
        {
            ...
            else
            {
               ...
               userServiceuserService.UpdateUser(UserSession.LoggedInUserEmail,getUser.Email,getUser.FirstName,getUser.LastName,getUser.PhoneNumber,getUser.Age,getUser.Address,getUser.Gender,getUser.Password,getUser.Wallet);
